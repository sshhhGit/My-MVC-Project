package com.sshhh.mymvcproject.util;
...
import com.sshhh.mymvcproject.exception.AttachFileException;
...
public class FileUtils {
    ...
    /** 업로드 경로 */
    private final String uploadPath = Paths.get("D:", "back", "upload", today).toString();
